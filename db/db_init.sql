-- 1. 如果数据库已存在则删除，重新创建
DROP
DATABASE IF EXISTS takeout_system;
CREATE
DATABASE takeout_system CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
INSERT INTO sys_user (username, password, real_name, role_type, credit_score)
VALUES ('admin', '123456', '系统管理员', 4, 0),
       ('zhangsan', '123456', '张三', 1, 10),
       ('burger_king', '123456', '汉堡王商家', 2, 0),
       ('rider_knight', '123456', '极速骑手', 3, 0);

-- 插入骑手详细信息
INSERT INTO rider_info (user_id, is_full_time, status, avg_speed)
VALUES (4, 1, 0, 10.5);
-- 关联 user_id = 4 的骑手
...
INSERT INTO product (merchant_id, category_id, name, description, price, image_url, upload_date, order_count)
VALUES (3, 1, '经典双层芝士汉堡', '芝士浓郁，牛肉多汁', 25.00, '/images/burger1.jpg', CURDATE(), 120),
